#dataset = pd.read_csv(r'C:\Users\udai4\Downloads\Full Stack Data Science Notes\September\Sep 20th\20th- slr\20th- slr\SLR - House price prediction\House_data.csv')
import numpy as np 	
...
# Load the dataset
dataset = pd.read_csv(r'C:\bunty files\New folder\files\Data Science Projects\Salary_Data.csv')
